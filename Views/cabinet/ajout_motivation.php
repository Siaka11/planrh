        ...
        <div class="sticky-top secondary-menu-sticky-top">
          <div class="secondary-menu">
            <ul class="list-unstyled mb-0">
              ...
              <li><a class="active" href="../cabinet/motivations">motivations</a></li>
        ...
        <div class="user-dashboard-info-box">
          ...
          <form method="POST">
            ...
            <div class="row">
             ...
             <button class="btn btn-md btn-primary" name="ajout_motivation" > Ajouter une nouvelle motivation</button>
