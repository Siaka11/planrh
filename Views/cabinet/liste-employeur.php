        ...
        <div class="sticky-top secondary-menu-sticky-top">
          <div class="secondary-menu">
            <ul class="list-unstyled mb-0">
              ...
              <li><a class="active" href="../cabinet/employeurs">Employeurs</a></li>
          ...
          <div class="row mb-4">
            <div class="col-md-7 col-sm-5 d-flex align-items-center">
              <div class="section-title-02 mb-0 ">
                <h4 class="mb-0">Liste des employeurs</h4>
              </div>
            </div>
            ...
            <table class="table table-bordered" id="myTable">
              ...
              <tbody>
                ...
                <?php foreach($employeurs as $employeur) : ?>
                  <?php $i++ ?>
                <tr>
                  <td scope="row"> <b class="text-dark"><?=  $employeur->entreprise ?>  </b> 
                    <p class="mb-1 mt-2"><span class="text-decoration-underline">Gestionnaire :</span> <?= $employeur->nom ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Adresse :</span> <?= $employeur->siege ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Email :</span> <?= $employeur->email ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Contact :</span> <?= $employeur->telephone ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Adresse :</span> <?= $employeur->secteur ?></p>

                  </td>
                  <td>
                        <b class="text-primary"><?= $employeur->date_creation ?></b>
                  </td>
