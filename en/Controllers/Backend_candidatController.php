...
use App\Models_en\OffreModel;
use App\Models_en\DomaineModel;
use App\Models_en\CandidatModel;
use App\Models_en\EmployeurModel;
use App\Models_en\FormationModel;
use App\Models_en\CompetenceModel;
use App\Models_en\ExperienceModel;
use App\Models_en\RecompenseModel;
use App\Models_en\Aimer_Candidat_Offre_Model;
use App\Models_en\Postuler_Candidat_Offre_Model;
...
class Backend_candidatController extends Controller{
    ...
    public function supprimerformation($id){
        ...
        $_SESSION["message"] = "Veuillez s'il vous plaît vous connecter!";
        header("Location: /fr/backend_candidat/modification_cv");
    ...
    public function modification_pass(){
        ...
        if(isset($_POST['modifierpassword'])){
            ...
            if( $passnew1 != $passnew2 ){
                ...
                header("Location: /fr/backend_candidat/modification_pass");
                exit;
            }
