...
<head>
    ...
    <title>Recrutement Permanent | Plan RH </title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="active"><a class="dropdown-item" href="chasseur-de-tete.php">Chasse de tête</a></li>
...
<div class="header-inner bg-light text-center">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-primary">Chasseur de Tête Spécialisé</h2>
        <ol class="breadcrumb mb-0 p-0">
          <li class="breadcrumb-item"><a href="index.html"> Accueil </a></li>
          <li class="breadcrumb-item active"> <i class="fas fa-chevron-right"></i> <span>CHASSEUR DE TÊTE SPÉCIALISÉ</span></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row" style="text-align:center;">
      <div class="col-12 section-title-02">
        <h5 class="text-center">NOTRE OBJECTIF : VOUS TROUVER LE MEILLEUR CANDIDAT</h5>
        <p>Nos chasseurs de tête comprennent l’importance des individus et ont une grande expérience avec les multinationales et les PME.</p>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/element-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Dec 2021 14:35:42 GMT -->
</html>
