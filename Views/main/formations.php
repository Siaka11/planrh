  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row mb-4">
          <div class="col-12">
            <h6 class="mb-0"><span class="text-primary">28 Formations Disponibles</span></h6>
          </div>
        </div>
          ...
          <div class="job-shortby ms-sm-auto d-flex align-items-center">
            <form class="form-inline">
              <div class="d-sm-flex align-items-center mb-0">
                <label class="justify-content-start me-2 mb-2 mb-sm-0">Triez :</label>
                <div class="short-by">
                  <select class="form-control basic-select">
                    <option>Formation 01</option>
                    <option>Formation 02</option>
                    <option>Formation 03</option>
                  </select>
                </div>
              </div>
            </form>
            <div class="filter-btn ms-sm-3 ms-auto"> <a class="btn btn-outline-primary" data-bs-toggle="collapse" href="#collapsefilter" role="button" aria-expanded="false" aria-controls="collapsefilter"><i class="fa fa-filter"></i>Recherche</a>
           </div>
          </div>
        </div>
        <!--
              ...
              <div class="job-list-details">
                <div class="job-list-info">
                  <div class="job-list-title">
                    <h5 class="mb-0"><a href="#">Formation 01</a></h5>
                  </div>
                  <div class="job-list-option">
                    <ul class="list-unstyled">
                      <li> <span>via : </span> <a href="employer-detail.html">Auteur de la Formation</a> </li>
                      <li><i class="fas fa-map-marker-alt pe-1"></i>Lieu de la Formation</li>
                      <li><i class="fas fa-filter pe-1"></i>Durée formation</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="job-list job-grid">
              ...
              <div class="job-list-details">
                <div class="job-list-info">
                  <div class="job-list-title">
                    <h5 class="mb-0"><a href="#">Formation 02</a></h5>
                  </div>
                  <div class="job-list-option">
                    <ul class="list-unstyled">
                      <li> <span>via : </span> <a href="employer-detail.html">Auteur de la Formation</a> </li>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="job-list job-grid">
              ...
              <div class="job-list-details">
                <div class="job-list-info">
                  <div class="job-list-title">
                    <h5 class="mb-0"><a href="#">Formation 03</a></h5>
                  </div>
                  <div class="job-list-option">
                    <ul class="list-unstyled">
                      <li> <span>via : </span> <a href="employer-detail.html">Auteur de la Formation</a> </li>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="job-list job-grid">
              ...
              <div class="job-list-details">
                <div class="job-list-info">
                  <div class="job-list-title">
                    <h5 class="mb-0"><a href="#">Formation 04</a></h5>
                  </div>
                  <div class="job-list-option">
                    <ul class="list-unstyled">
                      <li> <span>via : </span> <a href="employer-detail.html">Auteur de la Formation</a> </li>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="job-list job-grid">
              ...
              <div class="job-list-details">
                <div class="job-list-info">
                  <div class="job-list-title">
                    <h5 class="mb-0"><a href="#">Formation 05</a></h5>
                  </div>
                  <div class="job-list-option">
                    <ul class="list-unstyled">
                      <li> <span>via : </span> <a href="employer-detail.html">Auteur de la Formation</a> </li>
