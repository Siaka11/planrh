...
<head>
    ...
    <title>Impartition| Plan RH </title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="active"><a class="dropdown-item" href="impartition.php">Impartition</a></li>
    ...
    <div class="col-lg-12">
      <div class="category-style text-center">
        <a href="#" class="category-item">
          ...
          <h6>Centre d’appel</h6>
        </a>
        <a href="#" class="category-item">
          <div class="category-icon mb-4">
            <i class="flaticon-conversation"></i>
          </div>
          <h6>Centre de données</h6>
        </a>
        <a href="#" class="category-item">
          <div class="category-icon mb-4">
            <i class="flaticon-money"></i>
          </div>
          <h6>Entreposage & manutention</h6>
        </a>
        <a href="#" class="category-item">
          <div class="category-icon mb-4">
