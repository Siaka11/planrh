...
<head>
    ...
    <title>Gestion de La Paie| Plan RH </title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="active"><a class="dropdown-item" href="gestion-paie.php">Gestion de la Paie</a></li>
...
<div class="header-inner bg-light text-center">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-primary">Gestion Paie</h2>
        <ol class="breadcrumb mb-0 p-0">
          <li class="breadcrumb-item"><a href="index.html"> Accueil </a></li>
          <li class="breadcrumb-item active"> <i class="fas fa-chevron-right"></i> <span>Gestion de La Paie</span></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 section-title-02">
        <h5 class="text-center">GESTION DE LA PAIE EFFICACE ET SANS TRACAS</h5>
        <p>Plan Rh prend en charge la gestion de la rémunération des employés temporaires. Vous n’avez ainsi qu’une seule facture à régler. Tout simplement!</p>
