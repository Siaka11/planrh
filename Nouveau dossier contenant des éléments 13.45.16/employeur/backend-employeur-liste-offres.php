        ...
        <div class="sticky-top secondary-menu-sticky-top">
          <div class="secondary-menu">
            <ul>
              ...
              <li><a class="active" href="backend-employeur-liste-offres.php">Liste des Offres</a></li>
        ...
        <div class="user-dashboard-info-box mb-0">
          ...
          <div class="user-dashboard-table table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <th scope="row">offre 01
                    <p class="mb-1 mt-2">Date d'expiration: 202-04-15</p>
                  ...
                  <td>
                    <ul class="list-unstyled mb-0 d-flex">
                      ...
                      <li><a href="#" class="text-danger" data-bs-toggle="tooltip" title="Supprimer"><i class="far fa-trash-alt"></i></a></li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  <th scope="row">offre 02
                    <p class="mb-1 mt-2">Date d'expiration: 202-10-20</p>
                    <p class="mb-0">Adresse: Lieu du Poste</p>
                  </th>
                  <td>Metier 02</td>
                  <td><i class="far fa-star"></i></td>
                ...
                <tr>
                  <th scope="row">offre 03
                    <p class="mb-1 mt-2">Date d'expiration: 202-11-30</p>
                    <p class="mb-0">Adresse: Lieu du Poste</p>
                  </th>
                  <td>Metier 03</td>
                  <td><i class="far fa-star"></i></td>
                ...
                <tr>
                  <th scope="row">offre 04
                    <p class="mb-1 mt-2">Date d'expiration: 202-12-14</p>
                    <p class="mb-0">Adresse: Lieu du Poste</p>
                  </th>
                  <td>Metier 04</td>
                  <td><i class="far fa-star"></i></td>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/dashboard-employer-manage-jobs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Dec 2021 14:35:45 GMT -->
</html>
