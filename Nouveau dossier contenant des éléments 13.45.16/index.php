            ...
            <div class="row mt-4">
              ...
              <div class="col-lg-6 col-sm-6">
                <div class="job-list job-grid">
                  ...
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
                        <h6><a href="#">IT Manager</a></h6>
                      </div>
                      <div class="job-list-option">
                        <ul class="list-unstyled">
                          <li>
                            <span class="job-list-via">via</span>
                            <a class="job-list-company-name" href="#">Entreprise</a>
                          </li>
                          <li><i class="fas fa-map-marker-alt pe-1"></i>Abidjan</li>
                          <li><i class="fas fa-filter pe-1"></i>Digital</li>
                          <li><a class="part-time" href="#"><i class="fas fa-suitcase pe-1"></i>Freelance</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div class="job-list-favourite-time">
                    <a class="job-list-favourite order-2" href="#"><i class="far fa-heart"></i></a>
                    <span class="job-list-time order-1"><i class="far fa-clock pe-1"></i>3sem</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-sm-6">
                <div class="job-list job-grid">
                  ...
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
                        <h6><a href="#">Gestionnaire de stock</a></h6>
                      </div>
                      <div class="job-list-option">
                        <ul class="list-unstyled">
                          <li>
                          ...
                          <li><i class="fas fa-map-marker-alt pe-1"></i>Vridi</li>
                          <li><i class="fas fa-filter pe-1"></i>IT &amp; Telecoms</li>
                          <li><a class="part-time" href="#"><i class="fas fa-suitcase pe-1"></i>Plein Temps</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-lg-6 col-sm-6">
                <div class="job-list job-grid">
                    ...
                    <div class="job-list-info">
                      ...
                      <div class="job-list-option">
                        <ul class="list-unstyled">
                          ...
                          <li><i class="fas fa-map-marker-alt pe-1"></i>Lieu</li>
                          <li><i class="fas fa-filter pe-1"></i>Secteur</li>
                  ...
                  <div class="job-list-favourite-time">
                    <a class="job-list-favourite order-2" href="#"><i class="far fa-heart"></i></a>
                    <span class="job-list-time order-1"><i class="far fa-clock pe-1"></i>Durée</span>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="job-list-info">
                      ...
                      <div class="job-list-option">
                        <ul class="list-unstyled">
                          ...
                          <li><i class="fas fa-map-marker-alt pe-1"></i>Lieu</li>
                          <li><i class="fas fa-filter pe-1"></i>Secteur</li>
                          <li><a class="part-time" href="#"><i class="fas fa-suitcase pe-1"></i>Contrat</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="job-list-info">
                      ...
                      <div class="job-list-option">
                        <ul class="list-unstyled">
                          ...
                          <li><i class="fas fa-map-marker-alt pe-1"></i>Lieu</li>
                          <li><i class="fas fa-filter pe-1"></i>secteur</li>
                          <li><a class="full-time" href="#"><i class="fas fa-suitcase pe-1"></i>contrat</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <div class="collapse show" id="specialism">
              <div class="widget-content">                
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="specialism1">Domaine 1</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="specialism2">
                  <label class="form-check-label" for="specialism2">Domaine 2</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="specialism3">
                  <label class="form-check-label" for="specialism3">Domaine 3</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="specialism4">
                  <label class="form-check-label" for="specialism4">Domaine 4</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="specialism5">
                  <label class="form-check-label" for="specialism5">Domaine 5</label>
                </div>
              </div>
            </div>
          </div>
