        ...
        <div class="user-dashboard-info-box mb-0">
          ...
          <div class="user-dashboard-table table-responsive">
            <table class="table table-bordered" id="myTable">
              ...
              <tbody>
                <?php $i = 0 ?>
                <?php foreach($candidats as $candidats) : ?>
                  <?php $i++ ?>
                <tr>
                  <td scope="row"> <b class="text-dark">
                    ...
                    <p class="mb-0 "><span class="text-decoration-underline">Email :</span> <?= $candidats->email ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Poste :</span> <?= $candidats->poste ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Genre :</span> <?= $candidats->genre ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Date de naissance :</span> <?= $candidats->datenaissance ?></p>
                    <p class="mb-0 "><span class="text-decoration-underline">Description :</span> <?= $candidats->description ?></p>
