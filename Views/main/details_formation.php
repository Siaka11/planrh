...
<div class="header-inner bg-light text-center">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-primary">Les formations de PLAN RH</h2>
        <ol class="breadcrumb mb-0 p-0">
          <li class="breadcrumb-item"><a href="/main"> Accueil </a></li>
          <li class="breadcrumb-item active"> <i class="fas fa-chevron-right"></i> <span>Détails de la formation</span></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row" style="text-align:center;">
      <div class="col-12 section-title-02">
        <h5 class="text-center">TITRE DE LA FORMATION : <?= $formation->titre ?></h5>
        <p><?= $formation->titre ?></p>
    ...
    Service -->
      ...
      <div class="col-12">
        <div class="section-title text-start">
          <div class="row mt-5">
        <div class="col-12 section-title-02">
          <h4 class="text-center">Information sur la formation :</h4>
        </div>
    </div>
        </div>
      </div>
    ...
    <div class="row mb-4 mb-md-4">
      <div class="col-md-3 col-sm-6">
        <div class="d-flex mb-4">
          ...
          <p class="ps-3 align-self-center mb-0">Formateur : <?= $formation->auteur ?></p>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="d-flex mb-4">
          <i class="font-xlll text-primary flaticon-job-3"></i>
          <p class="ps-3 align-self-center mb-0">Date de debut: <?= $formation->date_debut ?> <br/> date de fin: <?= $formation->date_fin ?></p>
        </div>
      </div>
       <div class="col-md-3 col-sm-6">
        <div class="d-flex mb-4">
          <i class="font-xlll text-primary flaticon-chat"></i>
          <p class="ps-3 align-self-center mb-0">Coût: <?= $formation->cout ?></p>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="d-flex mb-4">
          <i class="font-xlll text-primary flaticon-chat"></i>
          <p class="ps-3 align-self-center mb-0">Lieu: <?= $formation->lieu ?></p>
        </div>
      </div>
    </div>
    <!-- <div class="row">
